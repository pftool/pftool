...
* in the case of performance testing, if the tester wishes to eleminate the 
...
* 	/dev/syndata.F5
* the tree specification would be equivelent to:
* 	L1D0F5+0
*
* Likewise the synthetic data source:
* 	/dev/synthetic-L3+0
* would have a tree specification equivelent to:
*	L3D1F1+0
*
...
* equivelent tree specification for the following synthetic data source:
* 	/dev/syndata_D5F10
* is
* 	L1D0F10+0
*
